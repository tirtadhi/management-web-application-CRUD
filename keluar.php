                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <!--menampilkan data-->
                                    <?php
                                        $ambilsemuadatastock = mysqli_query($conn,"select * from keluar k, stock s where s.idikan = k.idikan");
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <button type="submit" class="btn btn-primary" name="updateikankeluar">Submit</button>
                                                        </div>
                                                    </form>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <br>
                                                            <br>
                                                        <button type="submit" class="btn btn-danger" name="deleteikankeluar">Hapus</button>
                                                        </div>
                                                    </form>
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Tambah Ikan Keluar</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      ...
      <form method="post">
        ...
        <button type="submit" class="btn btn-primary" name="addikankeluar">Submit</button>
        </div>
      </form>
